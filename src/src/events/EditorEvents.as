package src.events
{
	...
	public class EditorEvents extends Event
	{
		 ...
		 * 更新UI
		 */
		public static const UPDATE_UI:String                = "UPDATE_UI";
		
		/**
		 *清空舞台 
		 */
		public static const CLEAR_STAGE:String              = "CLEAR_STAGE";
		 ...
		 * 生成XML成功
		 */		
		public static const CREATE_FILE_COMPLETE:String 	= "CREATE_FILE_COMPLETE";
